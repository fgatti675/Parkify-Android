...
/**
 * HandlerThread that unlocks itself when its work is complete. Used in conjunction with a WakeLock to accomplish this
 * end.
 */
public class WakefulThread extends HandlerThread {
	 ...
	 * 
	 * @param lock
	 *            Already-acquired WakeLock to be released when work done
	 * @param name
	...
	/**
	 * Override this method if you want to do something before the WakeLock is released when the thread's work is done
	 * or if an unhandled exception is raised while the thread runs
	 */
